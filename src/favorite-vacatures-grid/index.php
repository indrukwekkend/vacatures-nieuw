 ...
 */
 ...
 namespace IndrukwekkendVacatures\FavorietenVacaturesGrid;

function renderCallback($attributes) {
	ob_start(); ?>
	<div class="favorieten-update-me"><pre style="display: none;"><?php echo wp_json_encode($attributes) ?></pre></div>
 ...
 */
function register_block_indrukwekkend_favorieten_vacatures_grid() {
	register_block_type(
		'indrukwekkend/favorieten-vacatures-grid',
		array(
			'attributes'      => array(
				'align'                   => array(
					'type' => 'string',
...
add_action( 'init', __NAMESPACE__.'\register_block_indrukwekkend_favorieten_vacatures_grid' );
