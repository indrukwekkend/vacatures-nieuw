 ...
 */
function INDRUKWEKKEND_VACATURES_get_template( string $template, array $variables = [], bool $echo = false ) {

	$template_file = sprintf( '%1$s/templates/%2$s.php', INDRUKWEKKEND_VACATURES_PLUGIN_PATH, $template );
